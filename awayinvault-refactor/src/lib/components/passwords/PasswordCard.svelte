...
>
  ...
  <div class="space-y-1 min-w-0 flex-1">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-2.5 mt-3 pt-3 border-t border-border-subtle/40">
      <!-- Username -->
      ...
      <div class="flex items-center justify-between gap-2 text-xs">
        ...
        <div class="flex items-center gap-2 min-w-0">
          {#if !item.isDecrypted}
            <span class="text-red-500/80 font-medium font-mono text-[10px] uppercase tracking-wider">
              {item.password}
            </span>
            ...
            >
              {#if isPasswordVisible}
                <svg
                  ...
                  class="w-3.5 h-3.5"
                >
                  <path d="M17.94 17.94A10.07 10.07 0 0 1 12 19c-7 0-10-7-10-7a13.19 13.19 0 0 1 2.18-3.18L2 2l22 22-2.06-2.06" />
                  <path d="M6.61 6.61A13.52 13.52 0 0 1 12 5c7 0 10 7 10 7a13.17 13.17 0 0 1-2.18 3.18" />
  ...
  <!-- Actions Column -->
  <div class="flex items-center gap-2 self-end md:self-center opacity-70 group-hover:opacity-100 transition-opacity">
    <button

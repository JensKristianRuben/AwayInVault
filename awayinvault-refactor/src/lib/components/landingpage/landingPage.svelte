...
<main>
  ...
  <div class="hero-section">
    ...
    <div class="ui-overlay">
      <div class="center-content" in:fade={{ duration: 400, delay: 200 }}>
        ...
        <h1 bind:this={logoElement}
            class="brand-logo" 
            class:hovered-key={simMode === 'key'}>
          AWAYINVAULT
        </h1>
  ...
  <section class="feature-page zero-knowledge-section">
    <div class="container page-container">
      <div class="zk-title-container">
        ...
        <p class="page-subtitle">Dine data krypteres på din enhed, før de overhovedet forlader browseren. Vi kender aldrig din hovedadgangskode.</p>
      </div>
      ...
      <div class="zk-flow-animation">
        ...
        <div class="zk-node zk-device">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="node-icon">
          ...
          <div class="zk-key-overlay">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="key-icon">
        ...
        <div class="zk-connector">
          ...
          <div class="zk-packet">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="packet-icon">
          ...
          <div class="zk-shield-barrier">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="barrier-icon">
  ...
  <section class="feature-page biometric-section">
    <div class="container page-container">
      ...
      <p class="page-subtitle">Hurtig og sikker adgang med Windows Hello, FaceID eller fingeraftryk direkte fra alle dine enheder.</p>
    </div>
  </section>
  ...
  <section class="feature-page sync-section">
    <div class="container page-container">
      ...
      <p class="page-subtitle">Gem en adgangskode ét sted, og få den synkroniseret øjeblikkeligt til alle dine enheder under fuld kryptering.</p>
    </div>
  </section>
</main>
...
<style>
  ...
  .center-content {
    ...
    transform: translateY(-8vh); /* Trækker elementerne op for at give plads til formationer i bunden/midten */
  }
